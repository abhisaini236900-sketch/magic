...
async def cmd_rules(message: Message):
    rules = ["• Be kind and polite 🤗","• No hate speech ❌","• Share knowledge 📚","• No self-promotion without permission","• Use appropriate language","• Report issues to admins","• Keep discussions friendly"]
